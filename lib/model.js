(function () {
  ...
  */
  ...
  Model.types = {
    ...
    'boolean': function(value) {
      if (t.test(value) || value === true)
        return true;
      else if (f.test(value) || value === false)
        return false;
      return null;
    },
  ...
  Model.handlers = {
    ...
    fn: function(value, param, target, property) {
      return param.call(this, value, target, property)
    },
  ...
  * current model
  */
  Model.extend = function(rulesMap, handlers, messages) {
    var rv, key;
    function M() {}
    M.prototype = this;
    function R() {}
